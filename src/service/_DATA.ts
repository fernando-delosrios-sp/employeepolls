...
export let users: { [key: string]: User } = {
	...
	tylermcginnis: {
		...
		name: "Tyler McGinnis",
		avatarURL:
			"https://gravatar.com/avatar/b79aa7e9b7924c3408ba1e698d9d9145?s=400&d=robohash&r=x",
		answers: {
	...
	mtsamis: {
		...
		name: "Mike Tsamis",
		avatarURL:
			"https://gravatar.com/avatar/a15d153a1241109f29229334b33d3eae?s=400&d=robohash&r=x",
		answers: {
	...
	zoshikanlu: {
		...
		avatarURL:
			"https://gravatar.com/avatar/f6c8ba463e376f01db4c398bca7a8c30?s=400&d=robohash&r=x",
		answers: {
			xj352vofupe1dqz9emx13r: "optionOne",
		},
		questions: [],
